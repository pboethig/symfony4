...
$a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\ActorRepository' => function () {
    return ($this->privates['App\Repository\ActorRepository'] ?? $this->load('getActorRepositoryService.php'));
